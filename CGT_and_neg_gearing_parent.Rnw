...
# TARGET.FY <- "2015-16"
# use.sample.fy <- "2013-14"
revenue_quarantine_NG <- function(h, sample_file = sample_file_1314, new_CGT_discount = new.discount, sample_file_fy_year = use.sample.fy, target_fy = TARGET.FY){
  ...
  # Losses not permitted to be exhausted in year 1.
  M[1,2] <- 1
  M[1,1] <- 0
  #
  M[h,h] <- 1 - probCG
