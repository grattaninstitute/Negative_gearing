...
<<Import-HILDA, eval=FALSE, cache=TRUE>>=
hilda_w14_hh <- 
  foreign::read.dta("HILDA/Wave14/Household_n140c.dta")
@

<<Import-HILDA-ep, eval=FALSE, cache=TRUE>>=
hilda_w14_ep <- 
  foreign::read.dta("HILDA/Wave14/Eperson_n140c.dta")
@

<<Import-HILDA-rp, eval=FALSE, cache=TRUE>>=
hilda_w14_rp <- 
