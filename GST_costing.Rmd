...
hes10hh %>%
  ...
  geom_vline(aes(xintercept = decile_cuts), colour = theGrey) + 
  stat_smooth()  + 
...
hes10hh %>%
  ...
  grplot(aes(x = Current_weekly_HH_income_from_government_pensions_and_allowances,
             y = new_income_required)) +
  geom_point()
```
