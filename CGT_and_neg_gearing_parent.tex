...
As the RBA notes:
\begin{quote}
in most countries the earning of rental income is seen as the most important reason for investing in rental properties\dots This seems to stand in contrast to the situation in Australia where properties are commonly marketed on the presumption that they do not earn positive taxable income for a considerable period.
\end{quote}
...
\begin{figure}
\Caption{More people are negatively gearing and have higher losses}{Number of people negatively gearing property}{fig:number-NG-time-series} 
