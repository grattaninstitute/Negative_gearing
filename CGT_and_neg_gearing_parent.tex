...
A better balance between the competing considerations would reduce the discount so that \highlight{75~percent of capital gains are taxed}, which would raise around \highlight{\$3.89~billion} a year.
...
The proposed changes to negative gearing would reduce tax write-offs for property investment by about \$1.9~billion initially and \$1.9~billion over time. Assuming a discount rate of 
