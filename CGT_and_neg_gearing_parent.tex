...
\begin{overview*}[-35pt] \addcontentsline{toc}{chapter}{Overview}
Capital gains are only taxed at half the rate of personal income tax. Negative gearing allows those who borrow to invest -- usually in housing -- to use losses to reduce tax on wages and salaries. These tax settings are designed to encourage investment.

However, they do not balance appropriately other considerations, such as the economic costs of other taxes. Winding them back would raise around \highlight{\$5.2~billion} a year and reduce other economic distortions, while imposing little cost on those who can afford it least. This could help to reduce the Commonwealth Government's persistent budget deficits. 

A theoretically ideal tax treatment of savings wouldn't tax capital gains in line with inflation or the rewards for patience – the `risk free rate of return'. However, tax policy should also take into account other factors. The actual economic benefits of the capital gains discount are small because it doesn't increase savings much: those with high incomes tend to save almost the same amount irrespective of the tax rate. But the costs of the discount are high. Discounting capital gains means that other, more distorting, taxes must be higher. The discount also encourages investors to focus too much on investments with capital growth rather than annual income. The discount undermines the integrity of the income tax system by creating opportunities for artificial transactions to reduce tax. And the discount particularly helps high-income earners who earn most of the capital gains.

A better balance between the competing considerations would reduce the discount so that \highlight{75~percent of capital gains are taxed}, which would raise around \highlight{\$3.9~billion} a year.

Negative gearing in Australia goes beyond generally accepted principles for offsetting losses against gains. It distorts investment decisions, diverting capital from more productive investments, increasing volatility in housing markets, and increasing housing churn. It reduces home ownership and reduces the availability of long-term rentals, but does not materially increase housing supply. It is regressive, benefiting those on high incomes much more than those on low incomes. And it reduces tax collections, so that other costly taxes, or deficits, are higher.

Australia should follow international practice, and not deduct losses from passive investments from wage and salary income. Suggested carve-outs to deduct losses on new property, or up to a limit, or for a limited number of properties, leave too many of the problems in place.  In addition to the capital gains tax changes, restricting negative gearing would raise another \highlight{\$1.9~billion} a year in the short term, declining to \highlight{\$1.4~billion} as losses accumulate.

% We insert this now rather than pulling up the whole chunk from the box below.


These changes will improve housing affordability -- a little. We estimate housing prices would be up to 2~percent lower than otherwise. Because there are tight planning constraints on new supply for urban housing, there will be very little impact on rents, or the rate of new development, even in the long term. 
...
This is a challenge for all tax systems. Most OECD countries offer some type of discount or concession for capital gains,  although the hurdles to qualify for the most generous concessions can be high (Appendix B).

An idealised tax treatment on nominal capital gains that aims for neutrality between immediate consumption and savings depends on expected returns. Assuming that returns on property over the last 15 years have been unusually high (driven by the fall in interest rates), a neutral approach for most scenarios would tax capital gains more lightly than at present. 

Yet this idealised treatment needs to be balanced against other considerations. Perhaps the most important is that people tend to save almost the same amount irrespective of the tax rate on savings.  Higher taxes on capital gains would increase tax collections, contribute to repair of the Commonwealth government budget and provide room to reduce other taxes with higher economic costs. Higher taxes on capital gains would also reduce the tax bias toward capital gains and away from income producing assets, so that investment patterns would better reflect the economic fundamentals. They would also improve the integrity of the income tax system.

However, given that the tax is calculated on nominal (pre-inflation) capital gains are taxed, there remains some basis for continuing to offer a tax discount on gains. Reducing the discount from 50 per cent to zero -- in other words, taxing capital gains at the income tax rate -- would substantially increase the real effective tax rate on savings. As we show in chapter 4, a 25 per cent discount for capital gains would provide a fairer balance.
...
The proposed changes to negative gearing would reduce tax write-offs for property investment by about \$1.9~billion initially and \$1.4~billion over time. Assuming a discount rate of 
5~percent, the present value of these lost tax benefits would be approximately \$27.1~billion.


The proposed reduction of the capital gains tax discount to 25~percent would reduce after tax returns by about \$3.89~billion a year, or \$77.8~billion in perpetuity. Assuming 40~percent of this relates to gains on real estate (in line with 2013-14 gains realisations) then the expected present value of the lost benefits for would be approximately \$31.1~billion.



If these lost benefits (\$31.1~billion + \$27.1~billion) were fully capitalized into the value of residential property -- currently worth \$5.4~trillion -- prices would fall in the order of 1.2~percent.
...
In any case, general tax breaks like negative gearing are an inefficient way of supporting the rental market.\footnote{ 
  The most recent ABS lending data suggests that only 6.6~percent of recent lending to investors is for constructed properties (ABS Cat. 5671.0 Table 8). One recent paper suggests the 6.6~percent figure might be understated because the ABS data do not separately identify investor purchase of new housing (as opposed to construction of new housing). Assuming the share of lending for new dwellings by investors is a similar proportion as for owner occupiers, then 11.3~percent of lending for investment properties would be for new dwellings (either constructed or bought new). }   Blanket tax concessions for investors that primarily accrue to existing property owners through higher house prices are poorly targeted way of alleviating rental stress.  
...
We estimate that quarantining losses for passive investments would increase income tax collections by \$1.9~billion a year in the short term. Over the medium term, accrued losses -- losses not offset against recurrent investment income -- will be deducted from capital gains. Assuming no change in investor behaviour, the additional tax revenue would stabilise at around \$1.35~billion a year.
...
Only 44.8~percent of landlords have two or more properties.  A fraction of these would not be taxed as they would the `first property' for a landlord. The relatively small number of taxpayers affected substantially reduces the potential budget gains. 
...
In addition to raising more than \$5.24~billion a year, these changes will reduce (although not eliminate) distortions in investment choices toward debt financing of investment. Effective tax rates will increase a bit more for highly leveraged investors because they lose some of the tax benefits of upfront loss write offs \TBD{(Figure 18)}. However, effective tax rates will remain lower for this group because they still eventually write off their losses at a tax rate higher than they pay on gains. 
