...
value_of_NG_one_year <- value.of.ng.by.yr %>%
  filter(year == 2013) %$%
  total_benefit
...
value_without_NG <- value_of_dwelling_stock_expected_2025 - value_of_NG_perpertuity
(value_of_dwelling_stock_expected_2025 -  value_without_NG / (1+RoR_proprty))/ (value_of_dwelling_stock_expected_2025)
