...
if(require(extrafont) && grepl("Arial", fonts())){
  loadfonts()
...
Negative gearing is embedded in the Australian taxation system; 1.2~million taxpayers benefit from this policy. Homeowners benefit from the (artificially) higher prices. And the real estate lobby is vocal.  A superficial assessment might conclude that it is too difficult to change this policy. But 
\end{summary}
