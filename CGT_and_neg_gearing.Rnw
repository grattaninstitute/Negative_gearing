...
Let $V_0$ be the current value of (investor, residential) housing stock. Let $V_{10}$ be the value of $V_0$ in ten years' time. Let $V_{0\not{G}}'$ be the new value of housing stock in the absence of negative gearing. Let $G$ be value of negative gearing in perpertuity. Let $r$ be the rate of return demanded in residential property. So 
\[V_{10} = V_0(1 + r)^{10}\]
and by assumption
\begin{align*}
V_{10} - G &= V_{0\not{G}}' (1 + r)^{10} \\
...
Thus \[\frac{V_{0\not G}'}{V_0} = \text{\Sexpr{latex_percent(1 - value_of_NG_perpertuity/(total.value.of.property.2014 * (1 + RoR_proprty)^(10)))}}.\]
\end{bigbox*}
