...
<<knitrOptions, echo=FALSE, dev='pdf', echo=FALSE, message=FALSE, warning=FALSE>>=
...
# This function is 50 for 2012-13, as it 
# represents a 2% sample file.  Future years
# are a bit more subtle, as the sample file
# will be large (have more rows)
