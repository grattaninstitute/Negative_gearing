...
But the electorate also recognizes that housing is unaffordable.
\end{summary}
...
This means the effective tax rate paid on these gains is half the rate for other forms of income.
...
With more widespread availability of credit, borrowing has become a easier, increasing the popularity of this tax minimization strategy and thus the cost of revenue leakage to the budget.

\subsubsection{Tax concessions distory investment choices}
Lower taxes on capital gains also distort investment choices.
They create an incentive for investors to choose assets more likely to generate income through capital gains rather than operating income.
...
It is not clear whether deferral of taxes on gains until realisation, itself a significant tax advantage (section x.1), is itself enough to compensate investors for this risk. \textcite[p.~8]{Burman2009};  \textcite[p.~130]{Commission2004}}  But this effect may not be large.
