...
hes_with_gst_and_tax_compensation_indiv %>%
  ...
  summarise(new_benefit = weighted.mean(new_welfare + tax_diff_weekly, Weight_HH_HES),
            ...
            prop_increase_in_disp_inc = weighted.mean((new_welfare + tax_diff_weekly + Current_weekly_HH_disposable_income)/(Current_weekly_HH_disposable_income + Weekly_household_GST_on_all_goods_and_services_FIS/2), Weight_HH_HES),
